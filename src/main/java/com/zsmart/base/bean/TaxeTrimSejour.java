 ...
 */
@Entity
public class TaxeTrimSejour implements Serializable {
    ...
    @ManyToOne
    private TaxeAnnuelSejour taxeAnnuelSejour;

    public TaxeAnnuelSejour getTaxeAnnuelSejour() {
        return taxeAnnuelSejour;
    }

    public void setTaxeAnnuelSejour(TaxeAnnuelSejour taxeAnnuelSejour) {
        this.taxeAnnuelSejour = taxeAnnuelSejour;
    }
    ...
    public Integer getNumeroTrim() {
        return numeroTrim;
    }

    public void setNumeroTrim(Integer numeroTrim) {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof TaxeTrimSejour)) {
            return false;
        }
        TaxeTrimSejour other = (TaxeTrimSejour) object;
    ...
    public String toString() {
        return "com.zsmart.sejour.TaxeTrimSejour[ id=" + id + " ]";
    }
