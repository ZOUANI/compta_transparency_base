...
public class TaxeAnnuelSejourVo{
...
private TauxSejourVo tauxSejourVo ;
private List<TaxeTrimSejourVo>taxeTrimSejoursVo;
...
public TauxSejourVo  getTauxSejourVo (){
    return tauxSejourVo ;
}

public void setTauxSejourVo (TauxSejourVo  tauxSejourVo ){
     this.tauxSejourVo  = tauxSejourVo ;
}

public List<TaxeTrimSejourVo> getTaxeTrimSejoursVo(){
    return taxeTrimSejoursVo;
}

public void setTaxeTrimSejoursVo(List<TaxeTrimSejourVo> taxeTrimSejoursVo){
     this.taxeTrimSejoursVo = taxeTrimSejoursVo;
}
