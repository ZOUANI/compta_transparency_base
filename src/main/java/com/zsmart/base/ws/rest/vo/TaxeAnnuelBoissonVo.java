...
public class TaxeAnnuelBoissonVo{
...
private TauxBoissonVo tauxSejourVo ;
private List<TaxeTrimBoissonVo>taxeTrimBoissonsVo;
...
public TauxBoissonVo  getTauxSejourVo (){
    return tauxSejourVo ;
}

public void setTauxSejourVo (TauxBoissonVo  tauxSejourVo ){
     this.tauxSejourVo  = tauxSejourVo ;
}

public List<TaxeTrimBoissonVo> getTaxeTrimBoissonsVo(){
    return taxeTrimBoissonsVo;
}

public void setTaxeTrimBoissonsVo(List<TaxeTrimBoissonVo> taxeTrimBoissonsVo){
     this.taxeTrimBoissonsVo = taxeTrimBoissonsVo;
}
